      ...
      <div className="relative z-10 mx-auto w-full max-w-[900px]">
        ...
        <div className="mb-8 flex flex-col gap-4">
          ...
          <h1 className="font-headline-lg text-[48px] uppercase leading-none tracking-tighter text-white drop-shadow-[5px_5px_0px_rgba(0,0,0,1)] sm:text-[64px]">
            {t('tou.header.title.part1')}<span className="block text-primary-container">{t('tou.header.title.part2')}</span>
          </h1>
          <p className="font-body-sm text-on-surface-variant">{t('tou.header.updated')}</p>
        </div>

        {/* Content */}
        <div className="flex flex-col gap-6">
          <Section title={t('tou.section.acceptance.title')}>
            {t('tou.section.acceptance.body')}
          </Section>

          <Section title={t('tou.section.service.title')}>
            {t('tou.section.service.body')}
          </Section>

          <Section title={t('tou.section.account.title')}>
            {t('tou.section.account.body')}
          </Section>

          <Section title={t('tou.section.conduct.title')}>
            {t('tou.section.conduct.body')}
          </Section>

          <Section title={t('tou.section.ip.title')}>
            {t('tou.section.ip.body')}
          </Section>

          <Section title={t('tou.section.tierlist.title')}>
            {t('tou.section.tierlist.body')}
          </Section>

          <Section title={t('tou.section.thirdparty.title')}>
            {t('tou.section.thirdparty.body')}
          </Section>

          <Section title={t('tou.section.liability.title')}>
            {t('tou.section.liability.body')}
          </Section>

          <Section title={t('tou.section.changes.title')}>
            {t('tou.section.changes.body')}
          </Section>

          <Section title={t('tou.section.termination.title')}>
            {t('tou.section.termination.body')}
          </Section>

          <Section title={t('tou.section.law.title')}>
            {t('tou.section.law.body')}
          </Section>

          <Section title={t('tou.section.contact.title')}>
            {t('tou.section.contact.body')}
          </Section>
        </div>
